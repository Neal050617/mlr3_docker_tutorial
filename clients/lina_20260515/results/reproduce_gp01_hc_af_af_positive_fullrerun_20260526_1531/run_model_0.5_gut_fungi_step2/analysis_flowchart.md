...
```mermaid
graph TD
    A["数据输入<br/>145样本<br/>119特征"] --> B["数据预处理<br/>去除常数特征<br/>缺失值填充"]
...
| load_rdata | none |
| redraw_only | FALSE |
| load_preprocessed | /Users/colinliu/Desktop/mlr3_docker_tutorial/lina_20260515/reproduce_gp01_hc_af_af_positive_fullrerun_20260526_1531/run_model_0.5_gut_fungi_step1/preprocessed_data.RData |
| threshold | youden |
| pr_ci_boot | 200 |
| seed | 115702 |
| cores | 1 |
| outdir | /Users/colinliu/Desktop/mlr3_docker_tutorial/lina_20260515/reproduce_gp01_hc_af_af_positive_fullrerun_20260526_1531/run_model_0.5_gut_fungi_step2 |
