...
```mermaid
graph TD
    A["数据输入<br/>246样本<br/>327特征"] --> B["数据预处理<br/>去除常数特征<br/>缺失值填充"]
...
| load_rdata | none |
| redraw_only | FALSE |
| load_preprocessed | 20260403_lilei/reproduce_formal_case_positive_fullrerun_20260527_0156/run_model_0.1_step1/preprocessed_data.RData |
| threshold | youden |
| pr_ci_boot | 200 |
| seed | 115702 |
| cores | 1 |
| outdir | 20260403_lilei/reproduce_formal_case_positive_fullrerun_20260527_0156/run_model_0.1_step2 |
